...
if(isset($_GET['id'])){
	...
	$sql = mysqli_query($link,"SELECT * FROM products, product_sales, users 
			WHERE product_sales.customer_id = $id 
			AND product_sales.computer_id = product.product_id  
			AND product_sales.employee_id = users.user_id
